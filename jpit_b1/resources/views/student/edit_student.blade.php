      ...
      <div class="container">
        ...
        <input type="hidden" name="_method" value="PUT">
         ...
         <div class="mobile-view">
          <h4 class="text-center mb-4">Edit Profile of {{ $student->firstname }} {{ $student->lastname }}</h4>
        </div>
        ...
        <div class="row">
          <div class="col-md-3 profile-image">
            <div class="img-wrap shadow">
              ...
              <div class="dropzone" style="margin: 0 auto;">
                <img id="blah" src="{{ asset($student->profile_pic) }}" alt="my profile" class="upload-icon"/ style="width: 100%;height: 120px">
          ...
          <div class="col-md-9 sub-menu-content">
            <div class="px-lg-4">
              <h4 class="desktop-view">Edit Profile of {{ $student->firstname }} {{ $student->lastname }}</h4>
              ...
              <div class="shadow p-4 rounded info edited-form">
                ...
                <div class="form row">
                  <div class="col-md-6">
                    <div class="group">      
                      <input  id="email" type="email" name="email" value="{{ $student->email }}" required autocomplete="off">
                      @error('email')
                        <span class="error-text">{{ $message }}</span>
                      @enderror
                      <span class="highlight"></span>
                ...
                <div class="form row">
                  <div class="col-md-6">
                    <a type="button" class="btn btn-outline-secondary btn-block mb-3" href="{{ route('student.show') }}">Cancel</a>
                  </div>
                  <div class="col-md-6">
